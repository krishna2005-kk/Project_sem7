        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 space-y-2 mt-[20px]">
            ...
            {!isEnrolled ? (
              ...
              <button
                className="bg-green-200 text-green-600 px-6 py-2 rounded hover:bg-gray-100 mt-3"
...
//   // Handle enrollment with Razorpay
//   const handleEnroll = async (courseId, userId) => {
//     try {
//       const { data: orderData } = await axios.post(
//         serverUrl + '/api/payment/create-order',
...
//         {/* Remaining code (Curriculum, Reviews, Instructor, etc.) stays same */}
//         {/* ... */}
//       </div>
//     </div>
//   );
...
//       const options = {
//         key: import.meta.env.VITE_RAZORPAY_KEY_ID,
//         amount: orderData.amount, // paisa me
//         currency: orderData.currency,
//         name: 'Virtual Courses',
//         description: 'Course Enrollment Payment',
//         order_id: orderData.id, // ✅ yahan id ka use
//         handler: async function (response) {
